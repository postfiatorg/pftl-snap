import { ExtendedCoreBlockchainAddressConfig, ComponentConfig, ExtendedCoreDialogConfig } from "@peersyst/react-components-core";
import { AnimatedProps, CollapseProps, AnimatedComponentProps, FadingSlideProps, ScaleProps, SlideProps } from "../Animated";
...
export interface BlockchainAddressConfig extends ExtendedCoreBlockchainAddressConfig<BlockchainAddressProps> {
}

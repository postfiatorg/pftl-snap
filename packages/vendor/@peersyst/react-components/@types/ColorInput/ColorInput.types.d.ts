...
export type ColorInputTextFieldProps<TFP extends TextFieldProps> = Omit<TFP, "value" | "onChange" | "defaultValue" | "hideError" | "required" | "label" | "LabelProps" | "Label" | "disabled" | "readonly" | "showValid" | "name" | "onValidated">;
export type CoreColorInputProps = CoreFormControlledComponentProps<Color, LabelProps>;
export interface ColorInputProps<TFP extends TextFieldProps = TextFieldProps> extends FormControlledComponentProps<CoreColorInputProps> {
    /**
     * Color type/s
     */

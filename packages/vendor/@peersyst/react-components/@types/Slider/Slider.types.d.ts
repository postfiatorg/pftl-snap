...
export type SliderProps = FormControlledComponentProps<CoreSliderProps<LabelProps>> & Omit<SliderUnstyledOwnProps, "components" | "componentsProps" | "classes" | "onChange" | "onChangeCommitted"> & {
    /**
     * Slider size
     */
    size?: SliderSize;
...
export type SliderOwnerState = SliderUnstyledOwnerState & {
    size: SliderSize;
};

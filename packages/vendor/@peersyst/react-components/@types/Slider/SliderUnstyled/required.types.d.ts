 ...
 */
export type DefaultComponentProps<M extends OverridableTypeMap> = BaseProps<M> & DistributiveOmit<ComponentPropsWithRef<M['defaultComponent']>, keyof BaseProps<M>>;
/**
...
export type SlotComponentProps<TSlotComponent extends ElementType, TOverrides, TOwnerState> = (Partial<ComponentPropsWithRef<TSlotComponent>> & TOverrides) | ((ownerState: TOwnerState) => Partial<ComponentPropsWithRef<TSlotComponent>> & TOverrides);
/**

import { AriaAttributes, CSSProperties, ElementType, HTMLAttributes, ReactElement, ReactNode, SyntheticEvent } from "react";
...
import { OverridableComponent, OverridableTypeMap, OverrideProps, SlotComponentProps } from "./required.types";
...
export type SliderUnstyledProps<D extends ElementType = SliderUnstyledTypeMap["defaultComponent"]> = OverrideProps<SliderUnstyledTypeMap<{}, D>, D> & {
    component?: D;
};

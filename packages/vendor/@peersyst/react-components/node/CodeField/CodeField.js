...
var _CodeInputs = require("./CodeInputs");
...
var CodeField = function CodeField(rawProps) {
  var props = (0, _reactComponentsCore.useMergeDefaultProps)("CodeField", rawProps);
  var type = props.type,
    digits = props.digits,
    gap = props.gap,
    name = props.name,
    ...
    Label = _props$Label === void 0 ? _FormControlLabel.FormControlLabel : _props$Label,
    error = props.error,
  ...
  var validation = (0, _reactComponentsCore.useTextInputValidation)(_objectSpread({
    minChars: [digits, ""]
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_FormControl.FormControl, _objectSpread(_objectSpread({
    ...
    children: function children(value, setValue, context) {
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_CodeInputs.CodeInputs, {
        type: type,
        digits: digits,
        gap: gap,
...
var _default = exports["default"] = CodeField;
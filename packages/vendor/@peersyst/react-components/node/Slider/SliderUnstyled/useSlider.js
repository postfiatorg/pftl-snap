...
function focusThumb(_ref3) {
  ...
  var doc = (0, _reactUtils.ownerDocument)(sliderRef.current);
...
function useSlider(parameters) {
  ...
  var _useControlledState = (0, _useControlledState3["default"])({
      controlled: valueProp,
      "default": defaultValue != null ? defaultValue : min,
      name: "Slider"
    }),
    _useControlledState2 = (0, _slicedToArray2["default"])(_useControlledState, 2),
    valueDerived = _useControlledState2[0],
    setValueState = _useControlledState2[1];
  ...
  var _useIsFocusVisible = (0, _reactHooks.useIsFocusVisible)(),
  ...
  var handleFocusRef = (0, _reactHooks.useForkRef)(focusVisibleRef, sliderRef);
  var handleRef = (0, _reactHooks.useForkRef)(ref, handleFocusRef);
  ...
  (0, _reactHooks.useEnhancedEffect)(function () {
  ...
  var handleTouchMove = (0, _reactHooks.useEventCallback)(function (nativeEvent) {
  ...
  var handleTouchEnd = (0, _reactHooks.useEventCallback)(function (nativeEvent) {
    var finger = trackFinger(nativeEvent, touchId);
    setDragging(false);
    if (!finger) {
      return;
  ...
  var handleTouchStart = (0, _reactHooks.useEventCallback)(function (nativeEvent) {
    if (disabled) {
      return;
    }
  ...
  var getHiddenInputProps = function getHiddenInputProps() {
    ...
    return _objectSpread(_objectSpread({
      ...
      style: _objectSpread(_objectSpread({}, _utils.visuallyHidden), {}, {

    ...
    children: [/*#__PURE__*/_jsx(Rail, _objectSpread({}, railProps)), /*#__PURE__*/_jsx(Track, _objectSpread({}, trackProps)), marks.filter(function (mark) {
      ...
      return /*#__PURE__*/_jsxs(React.Fragment, {
        children: [/*#__PURE__*/_jsx(Mark, _objectSpread(_objectSpread(_objectSpread({
          ...
          className: clsx(markProps.className, _defineProperty({}, classes.markActive, markActive))
          ...
          className: clsx(classes.markLabel, markLabelProps.className, _defineProperty({}, classes.markLabelActive, markActive)),
          children: mark.label
        })) : null]
      }, mark.value);
      ...
      return /*#__PURE__*/_jsx(React.Fragment, {
        children: /*#__PURE__*/_jsx(ValueLabelComponent, _objectSpread(_objectSpread(_objectSpread({}, !isHostComponent(ValueLabelComponent) && {
          valueLabelFormat: valueLabelFormat,
          valueLabelDisplay: valueLabelDisplay,
          ...
          children: /*#__PURE__*/_jsx(Thumb, _objectSpread(_objectSpread({
            "data-index": index,
            "data-focusvisible": focusedThumbIndex === index
          }, thumbProps), {}, {
            className: clsx(classes.thumb, thumbProps.className, _defineProperty(_defineProperty({}, classes.active, active === index), classes.focusVisible, focusedThumbIndex === index)),

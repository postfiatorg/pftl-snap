...
export var MaxCharsValidator = /*#__PURE__*/function (_BaseValidator) {
  _inherits(MaxCharsValidator, _BaseValidator);
  function MaxCharsValidator(chars, message, translate) {
    var _this;
    _classCallCheck(this, MaxCharsValidator);
  ...
  _createClass(MaxCharsValidator, [{
    key: "validate",

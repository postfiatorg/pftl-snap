import { CommonModalComponentProps, ExtendedCoreDialogConfig } from "@peersyst/react-components-core";
...
export type DialogButtonsLayoutJustification = "start" | "center" | "end" | "space-between" | "space-around" | "space-evenly";
export type DialogButtonsLayoutAlignment = "start" | "end" | "center" | "stretch" | "baseline";
export interface DialogProps<DialogConfig extends ExtendedCoreDialogConfig<{}> = ExtendedCoreDialogConfig<{}>> extends CommonModalComponentProps {
    notch?: ReactNode;
    title?: ReactNode;
    content?: ReactNode;

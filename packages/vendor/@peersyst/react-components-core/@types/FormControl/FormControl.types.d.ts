...
export interface FormControlProps<T = any> {
     ...
     */
    children: (value: T, setValue: (v: T) => any, setFocused: (focused: boolean) => any, error?: string) => ReactNode;
}
...
export interface CoreFormControlProps<LP extends {
    label: ReactChild;
} = any, T = any, ExtraChildrenParameters extends [...args: any] = []> extends Omit<FormControlProps<T>, "children"> {
    /**
...
export type BaseCoreFormControlledComponentProps<T, LP extends CoreLabelProps = CoreLabelProps> = Pick<CoreFormControlProps<LP, T>, Exclude<keyof CoreFormControlProps, "children" | "Label" | "validation" | "defaultValue">>;
export type CoreFormControlledComponentProps<T, LP extends CoreLabelProps = CoreLabelProps> = BaseCoreFormControlledComponentProps<T, LP> & {
    /**
     * Default value
     */
    defaultValue?: T;

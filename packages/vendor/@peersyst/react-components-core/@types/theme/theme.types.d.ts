...
export type TypographyVariants = "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "subtitle1" | "subtitle2" | "body1" | "body2" | "caption" | "button";
export interface TypographyVariantsOverrides {
}
export type ThemeTypography<T> = Record<OverridableStringUnion<TypographyVariants, TypographyVariantsOverrides>, T>;
...
export type TypographyType = CoreThemeTypes extends {
    TypographyType: infer T;
} ? T : any;
export type UnitsType = CoreThemeTypes extends {
    UnitsType: infer T;
} ? T : any;

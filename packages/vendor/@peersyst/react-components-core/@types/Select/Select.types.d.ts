...
export interface CoreSelectProps<T, SelectItemProps, LP extends CoreLabelProps, Multiple extends boolean = false> extends CoreFormControlledComponentProps<Multiple extends true ? T[] : T, LP> {
    /**

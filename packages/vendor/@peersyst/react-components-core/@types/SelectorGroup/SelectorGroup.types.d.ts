...
export type CoreSelectorGroupProps<T, LP extends CoreLabelProps, D extends SelectorDirection = "column", Multiple extends boolean = false, ST = SelectorController<LP>> = CoreFormControlledComponentProps<Multiple extends true ? T[] : T, LP> & Pick<CoreSelectorProps<T, LP, ST>, "controller" | "renderController"> & {
    /**

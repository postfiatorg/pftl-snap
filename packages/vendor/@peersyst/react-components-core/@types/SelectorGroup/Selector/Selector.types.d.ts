...
export type SelectorController<LP extends CoreLabelProps = CoreLabelProps> = BaseSelectorController | JSXElementConstructor<SelectorControllerProps<LP>>;
export interface SelectorChildrenContext<T> extends Omit<SelectorGroupContextType<T>, "setValue" | "value"> {
    isSelected: boolean;
    /**
...
export type CoreSelectorProps<T, LP extends CoreLabelProps = CoreLabelProps, ST = SelectorController<LP>> = Pick<SelectorProps<T>, Exclude<keyof SelectorProps<T>, "children">> & {
    /**
     * Selector type
     */
    controller?: ST;
     ...
     */
    renderController?: (context: SelectorChildrenContext<T> & {
        label?: ReactChild;
        value?: T;
    }) => ReactElement;

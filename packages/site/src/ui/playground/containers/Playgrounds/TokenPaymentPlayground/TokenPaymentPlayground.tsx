...
export interface TokenPaymentPlaygroundProps {
  className?: string;
...
const coldWalletConf = {
  publicKey: 'EDEC21AF274B8D0A9A68323D973348A072F67A9743A8A5B456147F13101CB87146',
  privateKey: 'EDE7AC462C3AC1656E6542468AD0135C1E1B29DE00CE0A8D1939A8FBB5D3CB3434',
  classicAddress: 'rDs1tpLzeros3TuDNKiaH2JD1SNgCLLPiM',
  seed: 'sEd7sgy55CusuvFLkxaHJiDCcwCiguc',
};

const hotWalletConf = {
  publicKey: 'ED63A8C8F36269875972029D0041614A2462436A47031FB441D45FDBFCC2AF4748',
  privateKey: 'EDDD017231563DA9041B03F7C14A53B6A2D51D5AA0980A978B934A1860B59B7220',
...
const w1Conf = {
  publicKey: 'ED8EB4214BE055A4DC31EF60B28D132024E9821C2E41602FCB1DC80BC9B5F07320',
  privateKey: 'EDB33CFDF297B0BFA89B8177C7A52354ACC3E1585331BFD4F6B5D06AB17CBCDF90',
...
// eslint-disable-next-line
const w2Conf = {
  publicKey: 'ED687C066F5F40CC7BE7D82BE339B3A1F735A4BB06787E3EC8F48D5BB852597D65',
  privateKey: 'ED2151F631C5281EDAC9214BC3141F898BBDADBC43C06EE0442869C963C000BEA4',
  classicAddress: 'rwHQBWVWmDhi9PNpj55C9mwagJ2iAWuFdG',
  seed: 'sEdVnnE4Cra3kEvoLAnRbu8LS34mR66',
};

// eslint-disable-next-line
const mnemonic = 'steak sponsor surround patch urban bean box october welcome enemy canvas gate';
...
export function TokenPaymentPlayground({ className, children, ...rest }: TokenPaymentPlaygroundProps) {
  ...
  return (
    <Col gap="2rem" css={{ padding: '4rem' }} className={clsx('', className)} {...rest}>
      {/* eslint-disable-next-line */}
      <Button onClick={createTrustSetTransaction}>Create TrustSet</Button>
      {/* eslint-disable-next-line */}
      <Button onClick={claimBCNTokens} disabled={network?.chainId !== NetworkChainId.TESTNET}>
        Claim 3 BCN Tokens
      </Button>
